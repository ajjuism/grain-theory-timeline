...
export const projects: Project[] = [
  {
    ...
    status: 'completed',
    isVideo: false,
    imageUrl: '/assets/photography/gamekraft/DSC02221.jpg',
  ...
  },
  {
    ...
    gallery: [
      ...
      '/assets/photography/lalit/day(3)-10.jpg',
      '/assets/photography/lalit/day(3)-11.jpg',
      '/assets/photography/lalit/day(3)-13.jpg',
      '/assets/photography/lalit/day(3)-14.jpg',
  ...
  },
  {
    ...
    gallery: [
      ...
      '/assets/photography/redsheer/DSC08477.jpg'
    ],
    videos: [
